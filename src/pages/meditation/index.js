    ...
    <Box width="100%">
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <Typography variant="body1" fontWeight="300" color="text.primary" textAlign="center">
            Курс медитаций
          </Typography>
          <Button variant="contained">Обзор курса</Button>
        </Box>
        <Divider />
        <Box width="580px" mx="auto" my={7}>
        ...
        >
          {videoCourse.lessons.map((lesson, index) => (
            <MeditationCard key={lesson.id} lesson={lesson} isSubscribed={true} index={index + 1} />
          ))}
        </Box>
        <Divider />
        <TrainersList />
